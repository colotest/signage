// Arrows converge toward the center on the diagonal — content shrinks to
// fit fully inside the frame, so the corners pull inward.
...
// Arrows diverge away from the center on the diagonal — content stretches
// out to fill the frame, so the corners push outward.
